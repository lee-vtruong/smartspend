                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end items-center pt-4 border-t border-gray-200 dark:border-white/10">
                                ...
                                <button
                                    type="submit"
                                    disabled={isSending}
                                    className="group px-6 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-primary to-primary/80 rounded-xl hover:from-primary/90 hover:to-primary/70 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                                >
                                    {isSending ? (
                                        <>
